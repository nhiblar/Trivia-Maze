...
public class TriviaView extends JFrame{
	...
	private JPanel masterPanel, mazePanel, questionPanel, comboPanel;
	...
	public TriviaView(){
		...
		comboPanel.add(CreateTrueFalsePanel(), BorderLayout.SOUTH);
	...
	public void updateQuestionPanel(Question question) {
		...
		System.out.println("Made it to updateQuestionPanel.");
		...
		if(str.equals("trueFalse")) {
			...
			System.out.println("Multiple choice reached in updateQuestionPanel.");
		}
	...
	private JPanel CreateQuestionDisplayPanel(String questionStr) {
		...
		System.out.println("\n" + questionStr + " : Made it to CreateQuestionDisplayPanel.");
